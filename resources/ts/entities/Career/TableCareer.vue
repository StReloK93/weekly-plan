...
const { t } = useI18n()
import AddForm from '@career/AddCareerForm.vue';
import EditForm from '@career/EditCareerForm.vue';
import DrillingRepository from '@career/CareerRepository';
import { onMounted, reactive, ref, computed } from 'vue';
import { useCareer } from '@career/CareerStore';
...
const TruckColumns = computed(() => [
   ...
   { key: "name", sortable: true, label: t('career.name') },
   { key: "shortname", sortable: true, label: t('career.code') },
