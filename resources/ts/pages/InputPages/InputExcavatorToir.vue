...
import Repository from '@/entities/ExcavatorToir/ExcavatorToirRepository';
...
async function onSaveChanges(excavator_id, day, change, value) {
   Repository.update({
      value: value,
      day: day,
...
async function getDrillingPositions() {
   ...
   try {
      ...
      formDataModels.value = createToirModels(daysList.value, pageData.excavators, result.data, 'excavator_id')
